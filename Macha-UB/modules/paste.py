...
from Macha-UB.core.main_cmd import machub_on_cmd, e_or_r
...
@machaub_on_cmd(command="paste", modlue=mod_file)
async def paste(client, message):
    paste_msg = await e_or_r(machaub_message=message, msg_text="`Pasting to Hastebin...`")
